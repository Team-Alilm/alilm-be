...
class AlilmController(
    ...
    """)
    @GetMapping("/count")
    fun alilmHistory(): ResponseEntity<org.team_alilm.controller.alilm.AlilmController.AlilmHistoryResponse> {
        val result = alilmHistoryUseCase.alilmHistory()
        return ResponseEntity.ok(
            org.team_alilm.controller.alilm.AlilmController.AlilmHistoryResponse.Companion.from(
                result
            )
        )
    }
    ...
    data class AlilmHistoryResponse(
        ...
        companion object {
            fun from(alilmHistoryResult: AlilmHistoryUseCase.AlilmHistoryResult): org.team_alilm.controller.alilm.AlilmController.AlilmHistoryResponse {
                return org.team_alilm.controller.alilm.AlilmController.AlilmHistoryResponse(
