...
class GlobalRestControllerAdvice {
    ...
    fun handleIllegalArgument(e: IllegalArgumentException): ResponseEntity<ApiResponse<Unit>> {
        ...
        return ResponseEntity.badRequest()
            .body(ApiResponse.fail("INVALID_ARGUMENT", e.message ?: "잘못된 요청입니다."))
    }
    ...
    fun handleNoSuchElement(e: NoSuchElementException): ResponseEntity<ApiResponse<Unit>> {
        ...
        return ResponseEntity.status(404)
            .body(ApiResponse.fail("NOT_FOUND", e.message ?: "대상을 찾을 수 없습니다."))
    }
    ...
    fun handleException(e: Exception): ResponseEntity<ApiResponse<Unit>> {
        ...
        return ResponseEntity.internalServerError()
            .body(ApiResponse.fail("INTERNAL_ERROR", "알 수 없는 서버 오류가 발생했습니다."))
    }
}